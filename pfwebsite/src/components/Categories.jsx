        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col items-center space-x-12 justify-between py-8 md:py-16">
            ...
            <div className="flex relative pb-[10rem] flex-col mt-16 md:flex-row justify-center space-x-12 w-full">
              <div className="card1 z-[2] rotate-[-2.85deg] bg-white border-4 shadow-cool rounded-xl h-[50vh] scale-90 w-[25%] border-black">
                <h1 className="bg-[#D3F199] flex justify-center items-center text-[1.75rem] py-4 font-Bebas border-b-black border-4 border-x-0 border-t-0 w-[full] rounded-t-xl">
                  Nutrition
                </h1>
              ...
              <div className="card1 z-[2] rotate-[0.5deg] bg-white border-4 shadow-cool rounded-xl h-[50vh] scale-90 w-[25%] border-black">
                <h1 className="bg-[#FFBCE4] flex justify-center items-center text-[1.75rem] py-4 font-Bebas border-b-black border-4 border-x-0 border-t-0 w-[full] rounded-t-xl">
                  Health
                </h1>
                <div className=" h-[80%] flex items-center justify-center space-y-12 flex-col">
              ...
              <div className="card1 z-[2] rotate-[3.18deg] bg-white border-4 shadow-cool rounded-xl h-[50vh] scale-90 w-[25%] border-black">
                <h1 className="bg-[#E9DBFF] flex justify-center items-center text-[1.75rem] py-4 font-Bebas border-b-black border-4 border-x-0 border-t-0 w-[full] rounded-t-xl">
                  Fitness
                </h1>
                <div className=" h-[80%] flex items-center justify-center space-y-12 flex-col">
